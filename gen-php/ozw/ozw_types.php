...
final class OpenZWave_RemoteValueGenre {
...
final class OpenZWave_RemoteValueType {
...
final class OpenZWave_DriverControllerCommand {
  ...
  public function write($output) {
    ...
    if ($this->_nodeNeighbors !== null) {
      ...
      $xfer += $output->writeFieldBegin('_nodeNeighbors', TType::LST, 2);
      {
        ...
        {
          foreach ($this->_nodeNeighbors as $iter27)
          {
  ...
  public function write($output) {
    ...
    if ($this->o_associations !== null) {
      ...
      $xfer += $output->writeFieldBegin('o_associations', TType::LST, 2);
      {
        ...
        {
          foreach ($this->o_associations as $iter34)
          {
  ...
  public function write($output) {
    ...
    if ($this->_sceneIds !== null) {
      ...
      $xfer += $output->writeFieldBegin('_sceneIds', TType::LST, 2);
      {
        ...
        {
          foreach ($this->_sceneIds as $iter41)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem47 = null;
              $elem47 = new OpenZWave_RemoteValueID();
  ...
  public function write($output) {
    ...
    if ($this->o_value !== null) {
      ...
      $xfer += $output->writeFieldBegin('o_value', TType::LST, 2);
      {
        ...
        {
          foreach ($this->o_value as $iter48)
          {
