...
OpenZWave.NodeData.prototype.write = function(output) {
  ...
  if (this.m_sentFailed !== null && this.m_sentFailed !== undefined) {
    output.writeFieldBegin('m_sentFailed', Thrift.Type.I32, 2);
    output.writeI32(this.m_sentFailed);
    output.writeFieldEnd();
  }
  if (this.m_retries !== null && this.m_retries !== undefined) {
  ...
  if (this.m_ccData !== null && this.m_ccData !== undefined) {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i29 = 0; _i29 < _size24; ++_i29)
        {
          ...
          this._nodeNeighbors.push(elem30);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OpenZWave.UInt32_ListByte.prototype.write = function(output) {
  ...
  if (this._nodeNeighbors !== null && this._nodeNeighbors !== undefined) {
    ...
    for (var iter31 in this._nodeNeighbors)
    {
      if (this._nodeNeighbors.hasOwnProperty(iter31))
      {
        iter31 = this._nodeNeighbors[iter31];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i37 = 0; _i37 < _size32; ++_i37)
        {
          ...
          this.o_associations.push(elem38);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
OpenZWave.GetAssociationsReturnStruct.prototype.write = function(output) {
  ...
  if (this.o_associations !== null && this.o_associations !== undefined) {
    ...
    for (var iter39 in this.o_associations)
    {
      if (this.o_associations.hasOwnProperty(iter39))
      {
        iter39 = this.o_associations[iter39];
...
OpenZWave.GetAllScenesReturnStruct.prototype.write = function(output) {
  ...
  if (this._sceneIds !== null && this._sceneIds !== undefined) {
    ...
    for (var iter47 in this._sceneIds)
    {
      if (this._sceneIds.hasOwnProperty(iter47))
      {
        iter47 = this._sceneIds[iter47];
...
OpenZWave.SceneGetValuesReturnStruct.prototype.write = function(output) {
  ...
  if (this.o_value !== null && this.o_value !== undefined) {
    ...
    for (var iter55 in this.o_value)
    {
      if (this.o_value.hasOwnProperty(iter55))
      {
        iter55 = this.o_value[iter55];
        iter55.write(output);
      }
    }
    output.writeListEnd();
