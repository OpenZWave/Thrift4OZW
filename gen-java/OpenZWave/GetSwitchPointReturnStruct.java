...
public class GetSwitchPointReturnStruct implements org.apache.thrift.TBase<GetSwitchPointReturnStruct, GetSwitchPointReturnStruct._Fields>, java.io.Serializable, Cloneable, Comparable<GetSwitchPointReturnStruct> {
  ...
  public int compareTo(GetSwitchPointReturnStruct other) {
    ...
    lastComparison = Boolean.valueOf(isSetO_hours()).compareTo(other.isSetO_hours());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetO_hours()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.o_hours, other.o_hours);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetO_minutes()).compareTo(other.isSetO_minutes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetO_minutes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.o_minutes, other.o_minutes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetO_setback()).compareTo(other.isSetO_setback());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetO_setback()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.o_setback, other.o_setback);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
