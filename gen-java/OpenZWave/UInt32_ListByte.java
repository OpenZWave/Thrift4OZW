...
public class UInt32_ListByte implements org.apache.thrift.TBase<UInt32_ListByte, UInt32_ListByte._Fields>, java.io.Serializable, Cloneable, Comparable<UInt32_ListByte> {
  ...
  public int compareTo(UInt32_ListByte other) {
    ...
    lastComparison = Boolean.valueOf(isSet_nodeNeighbors()).compareTo(other.isSet_nodeNeighbors());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSet_nodeNeighbors()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this._nodeNeighbors, other._nodeNeighbors);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
