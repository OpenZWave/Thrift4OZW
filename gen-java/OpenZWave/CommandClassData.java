...
public class CommandClassData implements org.apache.thrift.TBase<CommandClassData, CommandClassData._Fields>, java.io.Serializable, Cloneable, Comparable<CommandClassData> {
  ...
  public void unsetM_commandClassId() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __M_COMMANDCLASSID_ISSET_ID);
  }
  ...
  public boolean isSetM_commandClassId() {
    return EncodingUtils.testBit(__isset_bitfield, __M_COMMANDCLASSID_ISSET_ID);
  }

  public void setM_commandClassIdIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __M_COMMANDCLASSID_ISSET_ID, value);
  }
  ...
  public int compareTo(CommandClassData other) {
    ...
    lastComparison = Boolean.valueOf(isSetM_commandClassId()).compareTo(other.isSetM_commandClassId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetM_commandClassId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.m_commandClassId, other.m_commandClassId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
