...
public class Bool_GetNodeClassInformation implements org.apache.thrift.TBase<Bool_GetNodeClassInformation, Bool_GetNodeClassInformation._Fields>, java.io.Serializable, Cloneable {
  ...
  public void unset_classVersion() {
    __isset_bit_vector.clear(___CLASSVERSION_ISSET_ID);
  }
  ...
  public boolean isSet_classVersion() {
    return __isset_bit_vector.get(___CLASSVERSION_ISSET_ID);
  }

  public void set_classVersionIsSet(boolean value) {
    __isset_bit_vector.set(___CLASSVERSION_ISSET_ID, value);
  }
      ...
      switch (field.id) {
        ...
        case 2: // _CLASS_NAME
          if (field.type == org.apache.thrift.protocol.TType.STRING) {
            this._className = iprot.readString();
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
          break;
        case 3: // _CLASS_VERSION
          if (field.type == org.apache.thrift.protocol.TType.BYTE) {
            this._classVersion = iprot.readByte();
            set_classVersionIsSet(true);
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this._className != null) {
      ...
      oprot.writeString(this._className);
      oprot.writeFieldEnd();
    }
    oprot.writeFieldBegin(_CLASS_VERSION_FIELD_DESC);
    oprot.writeByte(this._classVersion);
    oprot.writeFieldEnd();
