...
public class Bool_UInt8 implements org.apache.thrift.TBase<Bool_UInt8, Bool_UInt8._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Bool_UInt8");
  ...
  private static final org.apache.thrift.protocol.TField O_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("o_value", org.apache.thrift.protocol.TType.BYTE, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new Bool_UInt8StandardSchemeFactory());
    schemes.put(TupleScheme.class, new Bool_UInt8TupleSchemeFactory());
  }

  public boolean retval; // required
  public byte o_value; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Bool_UInt8.class, metaDataMap);
  }
   ...
   */
  public Bool_UInt8(Bool_UInt8 other) {
  ...
  public Bool_UInt8 deepCopy() {
    return new Bool_UInt8(this);
  }
  ...
  public Bool_UInt8 setRetval(boolean retval) {
    this.retval = retval;
    setRetvalIsSet(true);
    return this;
  }
  ...
  public byte getO_value() {
    return this.o_value;
  }

  public Bool_UInt8 setO_value(byte o_value) {
    this.o_value = o_value;
    setO_valueIsSet(true);
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case O_VALUE:
      return Byte.valueOf(getO_value());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Bool_UInt8)
      return this.equals((Bool_UInt8)that);
    return false;
  }

  public boolean equals(Bool_UInt8 that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Bool_UInt8 other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Bool_UInt8 typedOther = (Bool_UInt8)other;
  ...
  private static class Bool_UInt8StandardSchemeFactory implements SchemeFactory {
    public Bool_UInt8StandardScheme getScheme() {
      return new Bool_UInt8StandardScheme();
    }
  }

  private static class Bool_UInt8StandardScheme extends StandardScheme<Bool_UInt8> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Bool_UInt8 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Bool_UInt8 struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeByte(struct.o_value);
      oprot.writeFieldEnd();
  ...
  private static class Bool_UInt8TupleSchemeFactory implements SchemeFactory {
    public Bool_UInt8TupleScheme getScheme() {
      return new Bool_UInt8TupleScheme();
    }
  }

  private static class Bool_UInt8TupleScheme extends TupleScheme<Bool_UInt8> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Bool_UInt8 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Bool_UInt8 struct) throws org.apache.thrift.TException {
