...
struct_info('commandClassData') ->
  {struct, [{1, byte}, {2, i32}, {3, i32}]}
;

struct_info('nodeData') ->
  {struct, [{1, i32}, {2, i32}, {3, i32}, {4, i32}, {5, i32}, {6, i32}, {7, string}, {8, string}, {9, i32}, {10, i32}, {11, byte}, {12, {list, byte}}, {13, {list, {struct, {'ozw_types', 'commandClassData'}}}}]}
;
...
struct_info_ext('commandClassData') ->
  {struct, [{1, undefined, byte, 'm_commandClassId', undefined}, {2, undefined, i32, 'm_sentCnt', undefined}, {3, undefined, i32, 'm_receivedCnt', undefined}]}
;

struct_info_ext('nodeData') ->
  {struct, [{1, undefined, i32, 'm_sentCnt', undefined}, {2, undefined, i32, 'm_sentFailed', undefined}, {3, undefined, i32, 'm_retries', undefined}, {4, undefined, i32, 'm_receivedCnt', undefined}, {5, undefined, i32, 'm_receivedDups', undefined}, {6, undefined, i32, 'm_rtt', undefined}, {7, undefined, string, 'm_sentTS', undefined}, {8, undefined, string, 'm_receivedTS', undefined}, {9, undefined, i32, 'm_lastRTT', undefined}, {10, undefined, i32, 'm_averageRTT', undefined}, {11, undefined, byte, 'm_quality', undefined}, {12, undefined, {list, byte}, 'm_lastReceivedMessage', []}, {13, undefined, {list, {struct, {'ozw_types', 'commandClassData'}}}, 'm_ccData', []}]}
;
...
struct_info_ext('listUInt8_Byte') ->
  {struct, [{1, undefined, {list, byte}, '_value', []}, {2, undefined, byte, '_length', undefined}]}
;
