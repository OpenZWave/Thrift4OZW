...
function_info('GetControllerNodeId', exceptions) ->
  {struct, []}
;
% GetSUCNodeId(This, _homeId)
function_info('GetSUCNodeId', params_type) ->
  {struct, [{1, i32}]}
;
function_info('GetSUCNodeId', reply_type) ->
  byte;
function_info('GetSUCNodeId', exceptions) ->
  {struct, []}
;
...
function_info('GetControllerPath', params_type) ->
  {struct, [{1, i32}]}
;
function_info('GetControllerPath', reply_type) ->
  string;
function_info('GetControllerPath', exceptions) ->
  {struct, []}
;
...
function_info('GetNodeClassInformation', exceptions) ->
  {struct, []}
;
% IsNodeAwake(This, _homeId, _nodeId)
function_info('IsNodeAwake', params_type) ->
  {struct, [{1, i32}, {2, byte}]}
;
function_info('IsNodeAwake', reply_type) ->
  bool;
function_info('IsNodeAwake', exceptions) ->
  {struct, []}
;
% IsNodeFailed(This, _homeId, _nodeId)
function_info('IsNodeFailed', params_type) ->
  {struct, [{1, i32}, {2, byte}]}
;
function_info('IsNodeFailed', reply_type) ->
  bool;
function_info('IsNodeFailed', exceptions) ->
  {struct, []}
;
% GetNodeQueryStage(This, _homeId, _nodeId)
function_info('GetNodeQueryStage', params_type) ->
  {struct, [{1, i32}, {2, byte}]}
;
function_info('GetNodeQueryStage', reply_type) ->
  string;
function_info('GetNodeQueryStage', exceptions) ->
  {struct, []}
;
...
function_info('SetValue_UInt8_UInt8', params_type) ->
  {struct, [{1, {struct, {'ozw_types', 'remoteValueID'}}}, {2, {list, byte}}, {3, byte}]}
;
...
function_info('CancelControllerCommand', exceptions) ->
  {struct, []}
;
% TestNetworkNode(This, _homeId, _nodeId, _count)
function_info('TestNetworkNode', params_type) ->
  {struct, [{1, i32}, {2, byte}, {3, i32}]}
;
function_info('TestNetworkNode', reply_type) ->
  {struct, []};
function_info('TestNetworkNode', exceptions) ->
  {struct, []}
;
% TestNetwork(This, _homeId, _count)
function_info('TestNetwork', params_type) ->
  {struct, [{1, i32}, {2, i32}]}
;
function_info('TestNetwork', reply_type) ->
  {struct, []};
function_info('TestNetwork', exceptions) ->
  {struct, []}
;
% HealNetworkNode(This, _homeId, _nodeId, _doRR)
function_info('HealNetworkNode', params_type) ->
  {struct, [{1, i32}, {2, byte}, {3, bool}]}
;
function_info('HealNetworkNode', reply_type) ->
  {struct, []};
function_info('HealNetworkNode', exceptions) ->
  {struct, []}
;
% HealNetwork(This, _homeId, _doRR)
function_info('HealNetwork', params_type) ->
  {struct, [{1, i32}, {2, bool}]}
;
function_info('HealNetwork', reply_type) ->
  {struct, []};
function_info('HealNetwork', exceptions) ->
  {struct, []}
;
% GetNumScenes(This)
...
function_info('GetAllScenes', exceptions) ->
  {struct, []}
;
% RemoveAllScenes(This, _homeId)
function_info('RemoveAllScenes', params_type) ->
  {struct, [{1, i32}]}
;
function_info('RemoveAllScenes', reply_type) ->
  {struct, []};
function_info('RemoveAllScenes', exceptions) ->
  {struct, []}
;
% CreateScene(This)
...
function_info('GetDriverStatistics', exceptions) ->
  {struct, []}
;
% GetNodeStatistics(This, _homeId, _nodeId)
function_info('GetNodeStatistics', params_type) ->
  {struct, [{1, i32}, {2, byte}]}
;
function_info('GetNodeStatistics', reply_type) ->
  {struct, {'ozw_types', 'getNodeStatisticsReturnStruct'}};
function_info('GetNodeStatistics', exceptions) ->
  {struct, []}
;
% SendAllValues(This)
