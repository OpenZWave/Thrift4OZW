...
package OpenZWave::RemoteManager_GetSUCNodeId_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetSUCNodeId_args->mk_accessors( qw( _homeId ) );
...
package OpenZWave::RemoteManager_GetSUCNodeId_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetSUCNodeId_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_GetControllerInterfaceType_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetControllerInterfaceType_args->mk_accessors( qw( _homeId ) );
...
package OpenZWave::RemoteManager_GetControllerInterfaceType_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetControllerInterfaceType_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_GetControllerPath_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetControllerPath_args->mk_accessors( qw( _homeId ) );
...
package OpenZWave::RemoteManager_GetControllerPath_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetControllerPath_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_IsNodeAwake_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_IsNodeAwake_args->mk_accessors( qw( _homeId _nodeId ) );
...
package OpenZWave::RemoteManager_IsNodeAwake_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_IsNodeAwake_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_IsNodeFailed_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_IsNodeFailed_args->mk_accessors( qw( _homeId _nodeId ) );
...
package OpenZWave::RemoteManager_IsNodeFailed_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_IsNodeFailed_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_GetNodeQueryStage_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetNodeQueryStage_args->mk_accessors( qw( _homeId _nodeId ) );
...
package OpenZWave::RemoteManager_GetNodeQueryStage_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetNodeQueryStage_result->mk_accessors( qw( success ) );
...
package OpenZWave::RemoteManager_TestNetworkNode_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_TestNetworkNode_args->mk_accessors( qw( _homeId _nodeId _count ) );
...
sub new {
  ...
  if (UNIVERSAL::isa($vals,'HASH')) {
    ...
    if (defined $vals->{_count}) {
      $self->{_count} = $vals->{_count};
    }
  }
  return bless ($self, $classname);
}
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == TType::I32) {
        $xfer += $input->readI32(\$self->{_count});
      } else {
        $xfer += $input->skip($ftype);
      }
      last; };
...
sub write {
  ...
  if (defined $self->{_count}) {
    ...
    $xfer += $output->writeI32($self->{_count});
    $xfer += $output->writeFieldEnd();
  }
  $xfer += $output->writeFieldStop();
  $xfer += $output->writeStructEnd();
...
package OpenZWave::RemoteManager_TestNetworkNode_result;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_TestNetwork_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_TestNetwork_args->mk_accessors( qw( _homeId _count ) );
...
package OpenZWave::RemoteManager_TestNetwork_result;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_HealNetworkNode_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_HealNetworkNode_args->mk_accessors( qw( _homeId _nodeId _doRR ) );
...
sub new {
  ...
  if (UNIVERSAL::isa($vals,'HASH')) {
    ...
    if (defined $vals->{_doRR}) {
      $self->{_doRR} = $vals->{_doRR};
    }
  }
  return bless ($self, $classname);
}
...
sub read {
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      last; };
      /^3$/ && do{      if ($ftype == TType::BOOL) {
        $xfer += $input->readBool(\$self->{_doRR});
      } else {
        $xfer += $input->skip($ftype);
      }
      last; };
...
sub write {
  ...
  if (defined $self->{_doRR}) {
    $xfer += $output->writeFieldBegin('_doRR', TType::BOOL, 3);
    $xfer += $output->writeBool($self->{_doRR});
    $xfer += $output->writeFieldEnd();
  }
  $xfer += $output->writeFieldStop();
  $xfer += $output->writeStructEnd();
...
package OpenZWave::RemoteManager_HealNetworkNode_result;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_HealNetwork_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_HealNetwork_args->mk_accessors( qw( _homeId _doRR ) );
...
package OpenZWave::RemoteManager_HealNetwork_result;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_RemoveAllScenes_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_RemoveAllScenes_args->mk_accessors( qw( _homeId ) );
...
package OpenZWave::RemoteManager_RemoveAllScenes_result;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_GetNodeStatistics_args;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetNodeStatistics_args->mk_accessors( qw( _homeId _nodeId ) );
...
package OpenZWave::RemoteManager_GetNodeStatistics_result;
use base qw(Class::Accessor);
OpenZWave::RemoteManager_GetNodeStatistics_result->mk_accessors( qw( success ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new OpenZWave::GetNodeStatisticsReturnStruct();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
package OpenZWave::RemoteManager_ping_args;
use base qw(Class::Accessor);
...
package OpenZWave::RemoteManager_ping_result;
use base qw(Class::Accessor);
...
sub GetControllerInterfaceType{
  my $self = shift;
  my $_homeId = shift;
...
sub GetSUCNodeId{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  return $self->{impl}->GetSUCNodeId($_homeId);
}
...
sub GetControllerInterfaceType{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  return $self->{impl}->GetControllerInterfaceType($_homeId);
}
...
sub GetControllerPath{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  return $self->{impl}->GetControllerPath($_homeId);
}
...
sub IsNodeAwake{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  return $self->{impl}->IsNodeAwake($_homeId, $_nodeId);
}
...
sub IsNodeFailed{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  return $self->{impl}->IsNodeFailed($_homeId, $_nodeId);
}
...
sub GetNodeQueryStage{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  return $self->{impl}->GetNodeQueryStage($_homeId, $_nodeId);
}
...
sub TestNetworkNode{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  my $_count = ($request->{'_count'}) ? $request->{'_count'} : undef;
  return $self->{impl}->TestNetworkNode($_homeId, $_nodeId, $_count);
}
...
sub TestNetwork{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_count = ($request->{'_count'}) ? $request->{'_count'} : undef;
  return $self->{impl}->TestNetwork($_homeId, $_count);
}
...
sub HealNetworkNode{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  my $_doRR = ($request->{'_doRR'}) ? $request->{'_doRR'} : undef;
  return $self->{impl}->HealNetworkNode($_homeId, $_nodeId, $_doRR);
}
...
sub HealNetwork{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_doRR = ($request->{'_doRR'}) ? $request->{'_doRR'} : undef;
  return $self->{impl}->HealNetwork($_homeId, $_doRR);
}
...
sub RemoveAllScenes{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  return $self->{impl}->RemoveAllScenes($_homeId);
}
...
sub GetNodeStatistics{
  ...
  my $_homeId = ($request->{'_homeId'}) ? $request->{'_homeId'} : undef;
  my $_nodeId = ($request->{'_nodeId'}) ? $request->{'_nodeId'} : undef;
  return $self->{impl}->GetNodeStatistics($_homeId, $_nodeId);
}
...
sub send_GetSUCNodeId{
  my $self = shift;
  my $_homeId = shift;

  $self->{output}->writeMessageBegin('GetSUCNodeId', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_GetSUCNodeId_args();
  $args->{_homeId} = $_homeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetSUCNodeId{
  ...
  my $result = new OpenZWave::RemoteManager_GetSUCNodeId_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetSUCNodeId failed: unknown result";
}
sub IsPrimaryController{
  my $self = shift;
  my $_homeId = shift;
...
sub GetControllerInterfaceType{
  ...
  my $_homeId = shift;
    ...
    $self->send_GetControllerInterfaceType($_homeId);
  return $self->recv_GetControllerInterfaceType();
}

sub send_GetControllerInterfaceType{
  my $self = shift;
  my $_homeId = shift;

  $self->{output}->writeMessageBegin('GetControllerInterfaceType', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_GetControllerInterfaceType_args();
  $args->{_homeId} = $_homeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetControllerInterfaceType{
  my $self = shift;
  ...
  my $result = new OpenZWave::RemoteManager_GetControllerInterfaceType_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetControllerInterfaceType failed: unknown result";
}
sub GetControllerPath{
  my $self = shift;
  my $_homeId = shift;
...
sub send_GetControllerPath{
  my $self = shift;
  my $_homeId = shift;

  $self->{output}->writeMessageBegin('GetControllerPath', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_GetControllerPath_args();
  $args->{_homeId} = $_homeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_GetControllerPath{
  ...
  my $result = new OpenZWave::RemoteManager_GetControllerPath_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetControllerPath failed: unknown result";
}
sub GetPollInterval{
  my $self = shift;
...
sub send_IsNodeAwake{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;

  $self->{output}->writeMessageBegin('IsNodeAwake', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_IsNodeAwake_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_IsNodeAwake{
  ...
  my $result = new OpenZWave::RemoteManager_IsNodeAwake_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "IsNodeAwake failed: unknown result";
}
sub IsNodeFailed{
  my $self = shift;
  my $_homeId = shift;
...
sub send_IsNodeFailed{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;

  $self->{output}->writeMessageBegin('IsNodeFailed', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_IsNodeFailed_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_IsNodeFailed{
  ...
  my $result = new OpenZWave::RemoteManager_IsNodeFailed_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "IsNodeFailed failed: unknown result";
}
sub GetNodeQueryStage{
  my $self = shift;
  my $_homeId = shift;
...
sub send_GetNodeQueryStage{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;

  $self->{output}->writeMessageBegin('GetNodeQueryStage', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_GetNodeQueryStage_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_GetNodeQueryStage{
  ...
  my $result = new OpenZWave::RemoteManager_GetNodeQueryStage_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetNodeQueryStage failed: unknown result";
}
sub GetValueLabel{
  my $self = shift;
  my $_id = shift;
...
sub send_TestNetworkNode{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;
  my $_count = shift;

  $self->{output}->writeMessageBegin('TestNetworkNode', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_TestNetworkNode_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->{_count} = $_count;
  $args->write($self->{output});
...
sub recv_TestNetworkNode{
  ...
  my $result = new OpenZWave::RemoteManager_TestNetworkNode_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_TestNetwork{
  my $self = shift;
  my $_homeId = shift;
  my $_count = shift;

  $self->{output}->writeMessageBegin('TestNetwork', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_TestNetwork_args();
  $args->{_homeId} = $_homeId;
  $args->{_count} = $_count;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_TestNetwork{
  ...
  my $result = new OpenZWave::RemoteManager_TestNetwork_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_HealNetworkNode{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;
  my $_doRR = shift;

  $self->{output}->writeMessageBegin('HealNetworkNode', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_HealNetworkNode_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->{_doRR} = $_doRR;
  $args->write($self->{output});
...
sub recv_HealNetworkNode{
  ...
  my $result = new OpenZWave::RemoteManager_HealNetworkNode_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_HealNetwork{
  my $self = shift;
  my $_homeId = shift;
  my $_doRR = shift;

  $self->{output}->writeMessageBegin('HealNetwork', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_HealNetwork_args();
  $args->{_homeId} = $_homeId;
  $args->{_doRR} = $_doRR;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_HealNetwork{
  ...
  my $result = new OpenZWave::RemoteManager_HealNetwork_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_RemoveAllScenes{
  my $self = shift;
  my $_homeId = shift;

  $self->{output}->writeMessageBegin('RemoveAllScenes', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_RemoveAllScenes_args();
  $args->{_homeId} = $_homeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
...
sub recv_RemoveAllScenes{
  ...
  my $result = new OpenZWave::RemoteManager_RemoveAllScenes_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_GetNodeStatistics{
  my $self = shift;
  my $_homeId = shift;
  my $_nodeId = shift;

  $self->{output}->writeMessageBegin('GetNodeStatistics', TMessageType::CALL, $self->{seqid});
  my $args = new OpenZWave::RemoteManager_GetNodeStatistics_args();
  $args->{_homeId} = $_homeId;
  $args->{_nodeId} = $_nodeId;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_GetNodeStatistics{
  ...
  my $result = new OpenZWave::RemoteManager_GetNodeStatistics_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
  ...
  die "GetNodeStatistics failed: unknown result";
}
sub SendAllValues{
  my $self = shift;
...
sub send_ping{
  ...
  my $args = new OpenZWave::RemoteManager_ping_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_ping{
  ...
  my $result = new OpenZWave::RemoteManager_ping_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub process_GetSUCNodeId {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_GetSUCNodeId_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_GetSUCNodeId_result();
    $result->{success} = $self->{handler}->GetSUCNodeId($args->_homeId);
    $output->writeMessageBegin('GetSUCNodeId', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_GetControllerInterfaceType {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_GetControllerInterfaceType_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_GetControllerInterfaceType_result();
    $result->{success} = $self->{handler}->GetControllerInterfaceType($args->_homeId);
    $output->writeMessageBegin('GetControllerInterfaceType', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_GetControllerPath {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_GetControllerPath_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_GetControllerPath_result();
    $result->{success} = $self->{handler}->GetControllerPath($args->_homeId);
    $output->writeMessageBegin('GetControllerPath', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_IsNodeAwake {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_IsNodeAwake_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_IsNodeAwake_result();
    $result->{success} = $self->{handler}->IsNodeAwake($args->_homeId, $args->_nodeId);
    $output->writeMessageBegin('IsNodeAwake', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_IsNodeFailed {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_IsNodeFailed_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_IsNodeFailed_result();
    $result->{success} = $self->{handler}->IsNodeFailed($args->_homeId, $args->_nodeId);
    $output->writeMessageBegin('IsNodeFailed', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_GetNodeQueryStage {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_GetNodeQueryStage_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_GetNodeQueryStage_result();
    $result->{success} = $self->{handler}->GetNodeQueryStage($args->_homeId, $args->_nodeId);
    $output->writeMessageBegin('GetNodeQueryStage', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_TestNetworkNode {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_TestNetworkNode_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_TestNetworkNode_result();
    $self->{handler}->TestNetworkNode($args->_homeId, $args->_nodeId, $args->_count);
    $output->writeMessageBegin('TestNetworkNode', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_TestNetwork {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_TestNetwork_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_TestNetwork_result();
    $self->{handler}->TestNetwork($args->_homeId, $args->_count);
    $output->writeMessageBegin('TestNetwork', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_HealNetworkNode {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_HealNetworkNode_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_HealNetworkNode_result();
    $self->{handler}->HealNetworkNode($args->_homeId, $args->_nodeId, $args->_doRR);
    $output->writeMessageBegin('HealNetworkNode', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}

sub process_HealNetwork {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_HealNetwork_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_HealNetwork_result();
    $self->{handler}->HealNetwork($args->_homeId, $args->_doRR);
    $output->writeMessageBegin('HealNetwork', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_RemoveAllScenes {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_RemoveAllScenes_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_RemoveAllScenes_result();
    $self->{handler}->RemoveAllScenes($args->_homeId);
    $output->writeMessageBegin('RemoveAllScenes', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_GetNodeStatistics {
    my ($self, $seqid, $input, $output) = @_;
    my $args = new OpenZWave::RemoteManager_GetNodeStatistics_args();
    $args->read($input);
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_GetNodeStatistics_result();
    $result->{success} = $self->{handler}->GetNodeStatistics($args->_homeId, $args->_nodeId);
    $output->writeMessageBegin('GetNodeStatistics', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
