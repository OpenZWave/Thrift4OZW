...
use base qw(Class::Accessor);
OpenZWave::RemoteManager_SetValue_UInt8_args->mk_accessors( qw( _id _value _length ) );
...
sub SetValue_UInt8{
  ...
  return $self->{impl}->SetValue_UInt8($_id, $_value, $_length);
}
...
sub process_SetValue_UInt8 {
    ...
    $input->readMessageEnd();
    my $result = new OpenZWave::RemoteManager_SetValue_UInt8_result();
    $result->{success} = $self->{handler}->SetValue_UInt8($args->_id, $args->_value, $args->_length);
