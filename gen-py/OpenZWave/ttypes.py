...
class ListUInt8_Byte:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, '_value', (TType.BYTE,None), None, ), # 1
    (2, TType.BYTE, '_length', None, None, ), # 2
  )

  def __init__(self, _value=None, _length=None,):
    self._value = _value
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('ListUInt8_Byte')
    if self._value is not None:
      oprot.writeFieldBegin('_value', TType.LIST, 1)
      oprot.writeListBegin(TType.BYTE, len(self._value))
      for iter27 in self._value:
        oprot.writeByte(iter27)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self._length is not None:
      oprot.writeFieldBegin('_length', TType.BYTE, 2)
...
class UInt32_ListByte:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i32 in xrange(_size28):
            ...
            self._nodeNeighbors.append(_elem33)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self._nodeNeighbors is not None:
      ...
      for iter34 in self._nodeNeighbors:
...
class GetAssociationsReturnStruct:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i39 in xrange(_size35):
            ...
            self.o_associations.append(_elem40)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.o_associations is not None:
      ...
      for iter41 in self.o_associations:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i53 in xrange(_size49):
            _elem54 = RemoteValueID()
            _elem54.read(iprot)
            self.o_value.append(_elem54)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
