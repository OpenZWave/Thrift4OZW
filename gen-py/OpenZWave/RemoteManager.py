...
class Iface:
  ...
  def GetControllerInterfaceType(self, _homeId):
    """
    Parameters:
     - _homeId
    """
...
class Client(Iface):
  ...
  def send_GetControllerInterfaceType(self, _homeId):
    self._oprot.writeMessageBegin('GetControllerInterfaceType', TMessageType.CALL, self._seqid)
    args = GetControllerInterfaceType_args()
    args._homeId = _homeId
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_GetControllerInterfaceType(self):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = GetControllerInterfaceType_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "GetControllerInterfaceType failed: unknown result");
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["GetControllerInterfaceType"] = Processor.process_GetControllerInterfaceType
  ...
  def process_GetControllerInterfaceType(self, seqid, iprot, oprot):
    args = GetControllerInterfaceType_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = GetControllerInterfaceType_result()
    result.success = self._handler.GetControllerInterfaceType(args._homeId)
    oprot.writeMessageBegin("GetControllerInterfaceType", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class GetControllerInterfaceType_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetControllerInterfaceType_args')
    if self._homeId is not None:
      oprot.writeFieldBegin('_homeId', TType.I32, 1)
      oprot.writeI32(self._homeId)
      oprot.writeFieldEnd()
...
class GetControllerInterfaceType_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('GetControllerInterfaceType_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.I32, 0)
      oprot.writeI32(self.success)
      oprot.writeFieldEnd()
