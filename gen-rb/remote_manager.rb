...
module OpenZWave
  module RemoteManager
    class Client
      ...
      def SetValue_UInt8(_id, _value, _length)
        send_SetValue_UInt8(_id, _value, _length)
        return recv_SetValue_UInt8()
      end

      def send_SetValue_UInt8(_id, _value, _length)
        send_message('SetValue_UInt8', SetValue_UInt8_args, :_id => _id, :_value => _value, :_length => _length)
      end
    ...
    class Processor
      ...
      def process_SetValue_UInt8(seqid, iprot, oprot)
        ...
        result.success = @handler.SetValue_UInt8(args._id, args._value, args._length)
