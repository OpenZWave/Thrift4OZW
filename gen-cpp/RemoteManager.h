...
class RemoteManagerIfFactory {
 public:
  typedef RemoteManagerIf Handler;

  virtual ~RemoteManagerIfFactory() {}

  virtual RemoteManagerIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) = 0;
  virtual void releaseHandler(RemoteManagerIf* /* handler */) = 0;
};

class RemoteManagerIfSingletonFactory : virtual public RemoteManagerIfFactory {
 public:
  RemoteManagerIfSingletonFactory(const boost::shared_ptr<RemoteManagerIf>& iface) : iface_(iface) {}
  virtual ~RemoteManagerIfSingletonFactory() {}

  virtual RemoteManagerIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(RemoteManagerIf* /* handler */) {}
...
typedef struct _RemoteManager_EnablePoll_args__isset {
  _RemoteManager_EnablePoll_args__isset() : _valueId(false), _intensity(true) {}
  bool _valueId;
  bool _intensity;
...
typedef struct _RemoteManager_SetConfigParam_args__isset {
  _RemoteManager_SetConfigParam_args__isset() : _homeId(false), _nodeId(false), _param(false), _value(false), _size(true) {}
  bool _homeId;
  bool _nodeId;
  bool _param;
  bool _value;
...
class RemoteManager_BeginControllerCommand_args {
 public:
  ...
  RemoteManager_BeginControllerCommand_args() : _homeId(0), _command((DriverControllerCommand::type)0), _highPower(0), _nodeId(0), _arg(0) {
  }
...
class RemoteManagerProcessor : public ::apache::thrift::TDispatchProcessor {
 protected:
  boost::shared_ptr<RemoteManagerIf> iface_;
  virtual bool dispatchCall(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid, void* callContext);
 private:
  typedef  void (RemoteManagerProcessor::*ProcessFunction)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*);
...
class RemoteManagerProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  RemoteManagerProcessorFactory(const ::boost::shared_ptr< RemoteManagerIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< RemoteManagerIfFactory > handlerFactory_;
};
