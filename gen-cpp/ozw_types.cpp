...
void swap(RemoteValueID &a, RemoteValueID &b) {
  using ::std::swap;
  swap(a._homeId, b._homeId);
  swap(a._nodeId, b._nodeId);
  swap(a._genre, b._genre);
  swap(a._commandClassId, b._commandClassId);
  swap(a._instance, b._instance);
  swap(a._valueIndex, b._valueIndex);
...
void swap(DriverData &a, DriverData &b) {
  using ::std::swap;
  swap(a.s_SOFCnt, b.s_SOFCnt);
  swap(a.s_ACKWaiting, b.s_ACKWaiting);
  swap(a.s_readAborts, b.s_readAborts);
  swap(a.s_badChecksum, b.s_badChecksum);
  swap(a.s_readCnt, b.s_readCnt);
  swap(a.s_writeCnt, b.s_writeCnt);
  swap(a.s_CANCnt, b.s_CANCnt);
  swap(a.s_NAKCnt, b.s_NAKCnt);
  swap(a.s_ACKCnt, b.s_ACKCnt);
  swap(a.s_OOFCnt, b.s_OOFCnt);
  swap(a.s_dropped, b.s_dropped);
  swap(a.s_retries, b.s_retries);
  swap(a.s_controllerReadCnt, b.s_controllerReadCnt);
  swap(a.s_controllerWriteCnt, b.s_controllerWriteCnt);
  swap(a.__isset, b.__isset);
}
...
void swap(GetSwitchPointReturnStruct &a, GetSwitchPointReturnStruct &b) {
  ...
  swap(a.o_hours, b.o_hours);
  swap(a.o_minutes, b.o_minutes);
  swap(a.o_setback, b.o_setback);
  swap(a.__isset, b.__isset);
}
...
void swap(UInt32_ListByte &a, UInt32_ListByte &b) {
  using ::std::swap;
  swap(a.retval, b.retval);
  swap(a._nodeNeighbors, b._nodeNeighbors);
  swap(a.__isset, b.__isset);
}
...
void swap(Bool_GetNodeClassInformation &a, Bool_GetNodeClassInformation &b) {
  using ::std::swap;
  swap(a.retval, b.retval);
  swap(a._className, b._className);
  swap(a._classVersion, b._classVersion);
  swap(a.__isset, b.__isset);
}
...
void swap(GetAssociationsReturnStruct &a, GetAssociationsReturnStruct &b) {
  using ::std::swap;
  swap(a.retval, b.retval);
  swap(a.o_associations, b.o_associations);
  swap(a.__isset, b.__isset);
}
